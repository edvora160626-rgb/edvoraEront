...
function useTheme(defaultTheme5 = systemDefaultTheme) {
...
var positions = compose_default(position, zIndex, top, right, bottom, left);
...
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  ...
  const [getSnapshot, subscribe2] = React7.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
  ...
  const match = maybeReactUseSyncExternalStore(subscribe2, getSnapshot, getServerSnapshot);
  return match;
}
function unstable_createUseMediaQuery(params = {}) {
  ...
  return function useMediaQuery2(queryInput, options = {}) {
    ...
    const matchMedia = React7.useMemo(() => {
...
function ThemeProvider2(props) {
  ...
  const upperPrivateTheme = useTheme2() || EMPTY_THEME4;
  if (true) {
  ...
  const Grid2 = React20.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime13.jsx)(GridRoot, {
      ...
      children: React20.Children.map(children, (child) => {
        var _a;
        if (React20.isValidElement(child) && isMuiElement(child, ["Grid"]) && container2 && child.props.container) {
...
var TextareaAutosize = React25.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime15.jsxs)(React25.Fragment, {
...
function useFormControlState({
  ...
  const muiFormControl = React27.useContext(FormControlContext_default);
  const result = {};
...
@mui/system/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HD4ML5KA.js.map
